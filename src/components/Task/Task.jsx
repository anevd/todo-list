				...
				<div className="card-content">
					<p>
						<label>
							...
							/>
							<span style={/* status */ checked === true ? resolvedClass : {}}>{text}</span>
						</label>
					</p>
					<div className="card-content_icons">
						<svg className="card-content_edit" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 32 32" enableBackground="new 0 0 32 32">
							<g>
								<path
									fill="#000000"
